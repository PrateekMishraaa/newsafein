...
- Attract the attention of the Rescue Team by making a loud noise.`,
          ...
          <div style={{ marginTop: '30px', marginBottom: '30px', textAlign: 'center' }}>
            ...
            <div className='relative top-4'>
              <button className='h-10 w-28  rounded-md gap-2 bg-[#8BAE3F] text-white font-semibold cursor-pointer h-20 w-40 border-2 border-green-700' onClick={handleSubmit} type='submit'>Submit</button>
            </div>
                </div>
 ...
 <div className="flex justify-between p-4">
  ...
  <button
    ...
    className={`px-6 py-2 rounded-lg font-medium shadow-md transition-all duration-300 ${
      activeTab === 0
        ? 'bg-gray-100 text-gray-400 border-2 border-green-700 cursor-not-allowed'
  ...
  <button
    ...
    className={`px-6 py-2 rounded-lg font-medium shadow-md transition-all duration-300 ${
      activeTab === tabs.length - 1
        ...
        : 'bg-[#8BAE3F] text-white hover:bg-[#7DA334] hover:scale-105'
    }`}
  >
...
export default SchoolManagementPlan;
// pm921670@gmail.com
//  Password123!