import { AddCircleOutlineTwoTone, FactCheckTwoTone } from "@mui/icons-material";
    ...
    <div>
      <div className="d-flex align-items-center justify-content-between">
        ...
        <div>
          ...
          >
          <AddCircleOutlineTwoTone/>&nbsp;Add Track
          </Button>
        </div>
      </div>
      ...
      <form action="">
        ...
        <div>
          <Button
            variant="outlined"
            className="text-capitalize rounded mt-4 py-2"
            color="success"
            size="large"
          >
          <FactCheckTwoTone/>&nbsp;&nbsp;Save
          </Button>
        </div>
      </form>
    </div>
